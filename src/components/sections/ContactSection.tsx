          ...
          <div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <a href={`tel:${BRAND.phone}`} className="text-brand-gold text-2xl font-heading hover:text-brand-white transition-colors">{BRAND.phone}</a>
              </div>
              <div>
                <h4 className="text-brand-white font-bold tracking-widest text-sm mb-2">WHATSAPP</h4>
                <a href={`https://wa.me/${BRAND.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noreferrer" className="text-brand-gold text-2xl font-heading hover:text-brand-white transition-colors">{BRAND.whatsapp}</a>
              </div>
              <div>
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input required type="text" className="w-full bg-brand-black border-b border-brand-white/20 px-0 py-3 text-brand-white focus:outline-none focus:border-brand-gold transition-colors" placeholder="Your Name" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold tracking-widest text-brand-white/60">PHONE NUMBER</label>
                        <input required type="tel" className="w-full bg-brand-black border-b border-brand-white/20 px-0 py-3 text-brand-white focus:outline-none focus:border-brand-gold transition-colors" placeholder="Your Phone" />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <select className="w-full bg-brand-black border-b border-brand-white/20 px-0 py-3 text-brand-white focus:outline-none focus:border-brand-gold transition-colors appearance-none">
                      ...
                      <div className="space-y-2">
                        ...
                        <input type="date" className="w-full bg-brand-black border-b border-brand-white/20 px-0 py-3 text-brand-white focus:outline-none focus:border-brand-gold transition-colors" />
                      </div>
                    </div>

                    <div className="space-y-2">
                      <label className="text-xs font-bold tracking-widest text-brand-white/60">MESSAGE</label>
                      <textarea rows={4} className="w-full bg-brand-black border-b border-brand-white/20 px-0 py-3 text-brand-white focus:outline-none focus:border-brand-gold transition-colors resize-none" placeholder="Tell us more about your event..."></textarea>
                    </div>

                    <button 
                      type="submit" 
                      disabled={isSubmitting}
                      className="w-full py-5 bg-brand-gold text-brand-black font-bold tracking-[0.2em] hover:bg-brand-white transition-colors mt-8 disabled:opacity-70 flex items-center justify-center"
                    >
                      {isSubmitting ? (
