      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-2xl animate-on-scroll">
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-brand-white leading-tight mb-8">
          ...
          <div className="relative h-[400px] md:h-[600px] w-full group animate-on-scroll mt-8 lg:mt-0">
