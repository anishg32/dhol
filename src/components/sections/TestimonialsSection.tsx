...
export default function TestimonialsSection() {
  return (
    <section className="py-32 bg-brand-black relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-brand-red/5 via-brand-black to-brand-black opacity-50" />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {TESTIMONIALS.map((testimonial, idx) => (
            ...
            >
              <div className="flex space-x-1 text-brand-red mb-6">
